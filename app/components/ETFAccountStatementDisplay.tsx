...
interface ETFAccountStatementDisplayProps {
  data: any;
}

export default function ETFAccountStatementDisplay({ data }: ETFAccountStatementDisplayProps) {
  ...
  if (!data) {
    return (
      <div className="text-center py-12 text-dark-textSecondary">
        ...
        <p className="text-lg">No ETF account statement data available</p>
      </div>
    );
  }
  ...
  const totalBuys = filteredTransactions
    ...
    .reduce((sum: number, txn: any) => sum + (parseFloat(txn.amount || txn.value || txn.nav || 0) * parseFloat(txn.units || 0) || 0), 0);
      ...
      {filteredTransactions.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredTransactions.map((txn: any, idx: number) => {
            ...
            const amount = parseFloat(txn.nav || txn.amount || txn.value || 0) * parseFloat(txn.units || 0);
                ...
                >
                  <div className="flex items-center justify-between gap-4 mb-4">
                      ...
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                          <h4 className="text-lg font-bold text-dark-text">
                            {txn.isinDescription || txn.narration || txn.isin || 'Transaction'}
                          </h4>
                          {txn.isin && (
                    ...
                    <div className="text-right">
                      ...
                      {txn.nav && (
                        <p className="text-xs text-dark-textSecondary mt-1">NAV: {formatCurrency(txn.nav)}</p>
                      )}
